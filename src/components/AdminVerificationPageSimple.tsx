...
export const AdminVerificationPageSimple: React.FC = () => {
                          ...
                          <div className="min-w-0 flex-1">
                            <div className="flex items-center space-x-2">
                              <span className="text-sm font-medium text-gray-900">
                                ユーザーID: {verification.user_id.substring(0, 8)}...
                              </span>
                              <span className={`px-2 py-1 text-xs font-medium rounded-full ${getStatusColor(verification.status)}`}>
                                {getStatusText(verification.status)}
                              </span>
                            </div>
                            <p className="text-sm text-gray-600">商品ID: {verification.product_id.substring(0, 8)}...</p>
              ...
              <div className="p-6">
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <p className="mt-1 text-sm text-gray-900">{selectedVerification.user_id}</p>
                  </div>
                  
                  <div>
                    <label className="block text-sm font-medium text-gray-700">商品ID</label>
                    <p className="mt-1 text-sm text-gray-900">{selectedVerification.product_id}</p>
                  </div>
